function getBMapView(echarts) {
  ...
  */
  var _default = echarts.extendComponentView({
    type: 'bmap',
    remove: function() {
      this.bmap.removeEventListener('moving', this._oldMoveHandler); // FIXME
      this.bmap.removeEventListener('zoomend', this._oldZoomEndHandler);
    },
    dispose: function() {
      this.bmap.removeEventListener('moving', this._oldMoveHandler); // FIXME
      this.bmap.removeEventListener('zoomend', this._oldZoomEndHandler);
