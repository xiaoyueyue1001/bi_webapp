<template>
  <ZcmorefunChart :isFullscreen="isFullscreen" :isChartFullscreen="isChartFullscreen" :title="data.title" :option="option" :clickCallback="data.clickCallback" :datazoomCallback="data.datazoomCallback"></ZcmorefunChart>
</template>
