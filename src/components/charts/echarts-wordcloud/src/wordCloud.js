function initEchartsWordcloud(echarts) {
    // var echarts = require('echarts/lib/echarts');
    var layoutUtil = require('../../../apache-echarts-4.2.1-incubating-src/src/util/layout');

    var wordCloudSeries = require('./WordCloudSeries');
    wordCloudSeries.default(echarts);
    var wordCloudView = require('./WordCloudView');
    wordCloudView.default(echarts);
...
export default initEchartsWordcloud;